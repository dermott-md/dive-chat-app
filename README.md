...
> `YOUR_ORG` in the two `github.com/YOUR_ORG/dive-starter-kit` URLs above with your repo path.
> Vercel will prompt for the four environment variables on deploy.
